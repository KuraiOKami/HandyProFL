-- SMS Consent Tracking (Twilio Compliance)
...
COMMENT ON COLUMN profiles.sms_consent_given IS 'User has explicitly consented to receive SMS messages';
COMMENT ON COLUMN profiles.sms_consent_given_at IS 'Timestamp when user gave SMS consent';
